// **************************************************************
// Filename: Tsunami.h
// Robertsonics Tsunami WAV Trigger serial control library
// Date Created: 11/22/2016
// Updated: 11/02/25 by RDP to use SERIAL3 and added audio format comments
// **************************************************************

// Nov 2025: My Tsunami firmware requires a stereo WAV file with the following format:
// Use Audacity to:
//   1) Import audio file (File->Import->Audio)
//   2) File->Export Audio->To Computer
//   3) Click "Edit Metadata..." and click "Clear" to remove all tags; click "OK"
//   4) Format: WAV (Microsoft)
//   5) Channels: Stereo (it won't work with mono!)
//   6) Sample Rate: 44100 Hz
//   7) Encoding: Signed 16-bit PCM.
//   8) Click "Export"
