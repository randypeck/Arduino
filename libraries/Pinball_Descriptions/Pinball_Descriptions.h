...
// Tracks indexed 0-289; actual track numbers in string

// *** LINE 1: Track number + type + category (0-144) ***
...
const char diagAudioL1_180[] PROGMEM = "0811 COM AWARD";
const char diagAudioL1_181[] PROGMEM = "0812 COM AWARD";
const char diagAudioL1_182[] PROGMEM = "0821 COM AWARD";
const char diagAudioL1_183[] PROGMEM = "0822 COM AWARD";
const char diagAudioL1_184[] PROGMEM = "0823 COM AWARD";
const char diagAudioL1_185[] PROGMEM = "0824 COM AWARD";
const char diagAudioL1_186[] PROGMEM = "0831 COM AWARD";
const char diagAudioL1_187[] PROGMEM = "0841 COM AWARD";
const char diagAudioL1_188[] PROGMEM = "0842 COM AWARD";
const char diagAudioL1_189[] PROGMEM = "1001 SFX MODE";
const char diagAudioL1_190[] PROGMEM = "1002 COM MODE";
const char diagAudioL1_191[] PROGMEM = "1003 COM MODE";
const char diagAudioL1_192[] PROGMEM = "1004 SFX MODE";
const char diagAudioL1_193[] PROGMEM = "1005 COM MODE";
const char diagAudioL1_194[] PROGMEM = "1006 SFX MODE";
const char diagAudioL1_195[] PROGMEM = "1101 COM BUMPER";
const char diagAudioL1_196[] PROGMEM = "1111 COM BUMPER";
const char diagAudioL1_197[] PROGMEM = "1121 SFX BUMPER HIT";
const char diagAudioL1_198[] PROGMEM = "1122 SFX BUMPER HIT";
const char diagAudioL1_199[] PROGMEM = "1123 SFX BUMPER HIT";
const char diagAudioL1_200[] PROGMEM = "1124 SFX BUMPER HIT";
const char diagAudioL1_201[] PROGMEM = "1125 SFX BUMPER HIT";
const char diagAudioL1_202[] PROGMEM = "1126 SFX BUMPER HIT";
const char diagAudioL1_203[] PROGMEM = "1127 SFX BUMPER HIT";
const char diagAudioL1_204[] PROGMEM = "1128 SFX BUMPER HIT";
const char diagAudioL1_205[] PROGMEM = "1129 SFX BUMPER HIT";
const char diagAudioL1_206[] PROGMEM = "1130 SFX BUMPER HIT";
const char diagAudioL1_207[] PROGMEM = "1131 SFX BUMPER HIT";
const char diagAudioL1_208[] PROGMEM = "1132 SFX BUMPER HIT";
const char diagAudioL1_209[] PROGMEM = "1133 SFX BUMPER HIT";
const char diagAudioL1_210[] PROGMEM = "1141 SFX BUMPER MIS";
const char diagAudioL1_211[] PROGMEM = "1142 SFX BUMPER MIS";
const char diagAudioL1_212[] PROGMEM = "1143 SFX BUMPER MIS";
const char diagAudioL1_213[] PROGMEM = "1144 SFX BUMPER MIS";
const char diagAudioL1_214[] PROGMEM = "1145 SFX BUMPER MIS";
const char diagAudioL1_215[] PROGMEM = "1146 SFX BUMPER MIS";
const char diagAudioL1_216[] PROGMEM = "1147 SFX BUMPER MIS";
const char diagAudioL1_217[] PROGMEM = "1148 SFX BUMPER MIS";
const char diagAudioL1_218[] PROGMEM = "1197 SFX BUMPER ACH";
const char diagAudioL1_219[] PROGMEM = "1201 COM RAB";
const char diagAudioL1_220[] PROGMEM = "1211 COM RAB";
const char diagAudioL1_221[] PROGMEM = "1221 SFX RAB HIT";
const char diagAudioL1_222[] PROGMEM = "1222 SFX RAB HIT";
const char diagAudioL1_223[] PROGMEM = "1223 SFX RAB HIT";
const char diagAudioL1_224[] PROGMEM = "1224 SFX RAB HIT";
const char diagAudioL1_225[] PROGMEM = "1225 SFX RAB HIT";
const char diagAudioL1_226[] PROGMEM = "1241 SFX RAB MISS";
const char diagAudioL1_227[] PROGMEM = "1242 SFX RAB MISS";
const char diagAudioL1_228[] PROGMEM = "1243 SFX RAB MISS";
const char diagAudioL1_229[] PROGMEM = "1244 SFX RAB MISS";
const char diagAudioL1_230[] PROGMEM = "1245 SFX RAB MISS";
const char diagAudioL1_231[] PROGMEM = "1246 SFX RAB MISS";
const char diagAudioL1_232[] PROGMEM = "1247 SFX RAB MISS";
const char diagAudioL1_233[] PROGMEM = "1248 SFX RAB MISS";
const char diagAudioL1_234[] PROGMEM = "1249 SFX RAB MISS";
const char diagAudioL1_235[] PROGMEM = "1250 SFX RAB MISS";
const char diagAudioL1_236[] PROGMEM = "1251 SFX RAB MISS";
const char diagAudioL1_237[] PROGMEM = "1252 SFX RAB MISS";
const char diagAudioL1_238[] PROGMEM = "1253 SFX RAB MISS";
const char diagAudioL1_239[] PROGMEM = "1254 SFX RAB MISS";
const char diagAudioL1_240[] PROGMEM = "1297 SFX RAB ACH";
const char diagAudioL1_241[] PROGMEM = "1301 COM GOBBLE";
const char diagAudioL1_242[] PROGMEM = "1311 COM GOBBLE";
const char diagAudioL1_243[] PROGMEM = "1321 SFX GOBBLE HIT";
const char diagAudioL1_244[] PROGMEM = "1341 SFX GOBBLE MIS";
const char diagAudioL1_245[] PROGMEM = "1342 SFX GOBBLE MIS";
const char diagAudioL1_246[] PROGMEM = "1343 SFX GOBBLE MIS";
const char diagAudioL1_247[] PROGMEM = "1344 SFX GOBBLE MIS";
const char diagAudioL1_248[] PROGMEM = "1345 SFX GOBBLE MIS";
const char diagAudioL1_249[] PROGMEM = "1346 SFX GOBBLE MIS";
const char diagAudioL1_250[] PROGMEM = "1347 SFX GOBBLE MIS";
const char diagAudioL1_251[] PROGMEM = "1348 SFX GOBBLE MIS";
const char diagAudioL1_252[] PROGMEM = "1397 SFX GOBBLE ACH";
const char diagAudioL1_253[] PROGMEM = "2001 MUS CIRCUS";
const char diagAudioL1_254[] PROGMEM = "2002 MUS CIRCUS";
const char diagAudioL1_255[] PROGMEM = "2003 MUS CIRCUS";
const char diagAudioL1_256[] PROGMEM = "2004 MUS CIRCUS";
const char diagAudioL1_257[] PROGMEM = "2005 MUS CIRCUS";
const char diagAudioL1_258[] PROGMEM = "2006 MUS CIRCUS";
const char diagAudioL1_259[] PROGMEM = "2007 MUS CIRCUS";
const char diagAudioL1_260[] PROGMEM = "2008 MUS CIRCUS";
const char diagAudioL1_261[] PROGMEM = "2009 MUS CIRCUS";
const char diagAudioL1_262[] PROGMEM = "2010 MUS CIRCUS";
const char diagAudioL1_263[] PROGMEM = "2011 MUS CIRCUS";
const char diagAudioL1_264[] PROGMEM = "2012 MUS CIRCUS";
const char diagAudioL1_265[] PROGMEM = "2013 MUS CIRCUS";
const char diagAudioL1_266[] PROGMEM = "2014 MUS CIRCUS";
const char diagAudioL1_267[] PROGMEM = "2015 MUS CIRCUS";
const char diagAudioL1_268[] PROGMEM = "2016 MUS CIRCUS";
const char diagAudioL1_269[] PROGMEM = "2017 MUS CIRCUS";
const char diagAudioL1_270[] PROGMEM = "2018 MUS CIRCUS";
const char diagAudioL1_271[] PROGMEM = "2019 MUS CIRCUS";
const char diagAudioL1_272[] PROGMEM = "2051 MUS SURF";
const char diagAudioL1_273[] PROGMEM = "2052 MUS SURF";
const char diagAudioL1_274[] PROGMEM = "2053 MUS SURF";
const char diagAudioL1_275[] PROGMEM = "2054 MUS SURF";
const char diagAudioL1_276[] PROGMEM = "2055 MUS SURF";
const char diagAudioL1_277[] PROGMEM = "2056 MUS SURF";
const char diagAudioL1_278[] PROGMEM = "2057 MUS SURF";
const char diagAudioL1_279[] PROGMEM = "2058 MUS SURF";
const char diagAudioL1_280[] PROGMEM = "2059 MUS SURF";
const char diagAudioL1_281[] PROGMEM = "2060 MUS SURF";
const char diagAudioL1_282[] PROGMEM = "2061 MUS SURF";
const char diagAudioL1_283[] PROGMEM = "2062 MUS SURF";
const char diagAudioL1_284[] PROGMEM = "2063 MUS SURF";
const char diagAudioL1_285[] PROGMEM = "2064 MUS SURF";
const char diagAudioL1_286[] PROGMEM = "2065 MUS SURF";
const char diagAudioL1_287[] PROGMEM = "2066 MUS SURF";
const char diagAudioL1_288[] PROGMEM = "2067 MUS SURF";
const char diagAudioL1_289[] PROGMEM = "2068 MUS SURF";

// *** LINE 2: Short descriptions (0-144) ***
...
const char diagAudioL2_180[] PROGMEM = "Special is lit";
const char diagAudioL2_181[] PROGMEM = "Reeee-plaaay";
const char diagAudioL2_182[] PROGMEM = "Three in a row";
const char diagAudioL2_183[] PROGMEM = "Four corners";
const char diagAudioL2_184[] PROGMEM = "One two three";
const char diagAudioL2_185[] PROGMEM = "Five Gobble Hole";
const char diagAudioL2_186[] PROGMEM = "Spelled SCREAMO";
const char diagAudioL2_187[] PROGMEM = "EXTRA BALL";
const char diagAudioL2_188[] PROGMEM = "Send it";
const char diagAudioL2_189[] PROGMEM = "School Bell";
const char diagAudioL2_190[] PROGMEM = "Jackpot";
const char diagAudioL2_191[] PROGMEM = "Ten seconds left";
const char diagAudioL2_192[] PROGMEM = "Timer countdown";
const char diagAudioL2_193[] PROGMEM = "Time";
const char diagAudioL2_194[] PROGMEM = "Factory whistle";
const char diagAudioL2_195[] PROGMEM = "Bumper Cars intro";
const char diagAudioL2_196[] PROGMEM = "Keep smashing";
const char diagAudioL2_197[] PROGMEM = "Car honk";
const char diagAudioL2_198[] PROGMEM = "La cucaracha";
const char diagAudioL2_199[] PROGMEM = "Car honk 2x";
const char diagAudioL2_200[] PROGMEM = "Car honk 2x";
const char diagAudioL2_201[] PROGMEM = "Car honk 2x";
const char diagAudioL2_202[] PROGMEM = "Car honk 2x";
const char diagAudioL2_203[] PROGMEM = "Car honk 2x";
const char diagAudioL2_204[] PROGMEM = "Car honk rubber";
const char diagAudioL2_205[] PROGMEM = "Car honk rubber";
const char diagAudioL2_206[] PROGMEM = "Car honk aoooga";
const char diagAudioL2_207[] PROGMEM = "Diesel train";
const char diagAudioL2_208[] PROGMEM = "Car honk";
const char diagAudioL2_209[] PROGMEM = "Truck air horn";
const char diagAudioL2_210[] PROGMEM = "Car crash";
const char diagAudioL2_211[] PROGMEM = "Car crash";
const char diagAudioL2_212[] PROGMEM = "Car crash";
const char diagAudioL2_213[] PROGMEM = "Car crash";
const char diagAudioL2_214[] PROGMEM = "Car crash";
const char diagAudioL2_215[] PROGMEM = "Cat screech";
const char diagAudioL2_216[] PROGMEM = "Car crash";
const char diagAudioL2_217[] PROGMEM = "Car crash";
const char diagAudioL2_218[] PROGMEM = "Bell ding ding";
const char diagAudioL2_219[] PROGMEM = "Roll-A-Ball intro";
const char diagAudioL2_220[] PROGMEM = "Keep rolling hats";
const char diagAudioL2_221[] PROGMEM = "Bowling strike";
const char diagAudioL2_222[] PROGMEM = "Bowling strike";
const char diagAudioL2_223[] PROGMEM = "Bowling strike";
const char diagAudioL2_224[] PROGMEM = "Bowling strike";
const char diagAudioL2_225[] PROGMEM = "Bowling strike";
const char diagAudioL2_226[] PROGMEM = "Glass break";
const char diagAudioL2_227[] PROGMEM = "Glass break";
const char diagAudioL2_228[] PROGMEM = "Glass break";
const char diagAudioL2_229[] PROGMEM = "Glass break";
const char diagAudioL2_230[] PROGMEM = "Glass break";
const char diagAudioL2_231[] PROGMEM = "Glass break";
const char diagAudioL2_232[] PROGMEM = "Glass break";
const char diagAudioL2_233[] PROGMEM = "Glass break";
const char diagAudioL2_234[] PROGMEM = "Glass break";
...
const char diagAudioL2_239[] PROGMEM = "Goat sound";
const char diagAudioL2_240[] PROGMEM = "Ta da";
const char diagAudioL2_241[] PROGMEM = "Shooting Gallery";
const char diagAudioL2_242[] PROGMEM = "Keep shooting";
const char diagAudioL2_243[] PROGMEM = "Slide whistle";
const char diagAudioL2_244[] PROGMEM = "Ricochet";
const char diagAudioL2_245[] PROGMEM = "Ricochet";
const char diagAudioL2_246[] PROGMEM = "Ricochet";
const char diagAudioL2_247[] PROGMEM = "Ricochet";
const char diagAudioL2_248[] PROGMEM = "Ricochet";
const char diagAudioL2_249[] PROGMEM = "Ricochet";
const char diagAudioL2_250[] PROGMEM = "Ricochet";
const char diagAudioL2_251[] PROGMEM = "Ricochet";
const char diagAudioL2_252[] PROGMEM = "Applause";
const char diagAudioL2_253[] PROGMEM = "Barnum Bailey";
const char diagAudioL2_254[] PROGMEM = "Rensaz Race March";
const char diagAudioL2_255[] PROGMEM = "Twelfth Street Rag";
const char diagAudioL2_256[] PROGMEM = "Chariot Ben Hur";
const char diagAudioL2_257[] PROGMEM = "Organ Grinder";
const char diagAudioL2_258[] PROGMEM = "Hands Across Sea";
const char diagAudioL2_259[] PROGMEM = "Field Artillery";
const char diagAudioL2_260[] PROGMEM = "You Flew Over";
const char diagAudioL2_261[] PROGMEM = "Double Eagle";
const char diagAudioL2_262[] PROGMEM = "Ragtime Cowboy";
const char diagAudioL2_263[] PROGMEM = "Billboard March";
const char diagAudioL2_264[] PROGMEM = "El Capitan";
const char diagAudioL2_265[] PROGMEM = "Smiles";
const char diagAudioL2_266[] PROGMEM = "Spirit St Louis";
const char diagAudioL2_267[] PROGMEM = "The Free Lance";
const char diagAudioL2_268[] PROGMEM = "The Roxy March";
const char diagAudioL2_269[] PROGMEM = "Stars Stripes";
const char diagAudioL2_270[] PROGMEM = "Washington Post";
const char diagAudioL2_271[] PROGMEM = "Bombasto";
const char diagAudioL2_272[] PROGMEM = "Miserlou";
const char diagAudioL2_273[] PROGMEM = "Bumble Bee Stomp";
const char diagAudioL2_274[] PROGMEM = "Wipe Out";
const char diagAudioL2_275[] PROGMEM = "Banzai Washout";
const char diagAudioL2_276[] PROGMEM = "Hava Nagila";
const char diagAudioL2_277[] PROGMEM = "Sabre Dance";
const char diagAudioL2_278[] PROGMEM = "Malaguena";
const char diagAudioL2_279[] PROGMEM = "Wildfire";
const char diagAudioL2_280[] PROGMEM = "The Wedge";
const char diagAudioL2_281[] PROGMEM = "Exotic";
const char diagAudioL2_282[] PROGMEM = "The Victor";
const char diagAudioL2_283[] PROGMEM = "Mr Eliminator";
const char diagAudioL2_284[] PROGMEM = "Night Rider";
const char diagAudioL2_285[] PROGMEM = "The Jester";
const char diagAudioL2_286[] PROGMEM = "Pressure";
const char diagAudioL2_287[] PROGMEM = "Shootin Beavers";
const char diagAudioL2_288[] PROGMEM = "Riders in Sky";
const char diagAudioL2_289[] PROGMEM = "Bumble Bee Boogie";
...
const unsigned int NUM_DIAG_AUDIO = 290;
